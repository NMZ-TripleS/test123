...
(function () {
    ...
    669: function _() {
      var e = function e(_e) {
        ...
        return {
          ...
          dataField: null !== (n = _e.dataField) && void 0 !== n ? n : null,
          options: [],
          data: _e.data,
          selected: [],
          show: !1,
          init: function init() {
            for (var t = this, i = this.data, n = 0; n < i.length; n++) {
              this.options.push({
                value: i[n].value.id,
                text: i[n].value.name,
                selected: !1
            ...
            JSON.parse(_e.selected).forEach(function (e) {
              t.options.map(function (i) {
                i.value === e && (i.selected = !0, t.selected.push(i));
              });
            });
          },
      ...
      var o = function o(e) {
        ...
        return {
          ...
          onlyFuture: null !== (n = e.onlyFuture) && void 0 !== n && n,
  ...
  n.m = t, e = [], n.O = function (t, i, l, a) {
    if (!i) {
      var o = 1 / 0;

      for (d = 0; d < e.length; d++) {
        for (var _e$d = _slicedToArray(e[d], 3), i = _e$d[0], l = _e$d[1], a = _e$d[2], r = !0, u = 0; u < i.length; u++) {
  ...
  }(), n.O(void 0, [405], function () {
    return n(669);
  });
  var l = n.O(void 0, [405], function () {
    return n(930);
  });
  l = n.O(l);
})();
